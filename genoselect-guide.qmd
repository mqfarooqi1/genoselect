...
Load real genotype files into a 0/1/2 matrix with one call. All readers return a
`GenotypeData` with `.geno` (n_samples × n_markers), `.samples`, and `.markers`,
and are pure-Python (no extra dependencies).
